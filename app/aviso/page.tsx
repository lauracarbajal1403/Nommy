  ...
  return (
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      <main className="max-w-[900px] mx-auto px-6 py-8">
        ...
        <Section id="identidad" title="1. Identidad y Domicilio del Responsable" ref={sectionRefs} delay={0.1}>
        ...
        {/* Alcance */}
        <Section id="alcance" title="2. Alcance de este Aviso de Privacidad" ref={sectionRefs} delay={0.2}>
          <p className="mb-4 text-[#525252]">
        ...
        {/* Finalidad */}
        <Section id="finalidad" title="3. Finalidad del Tratamiento de los Datos" ref={sectionRefs} delay={0.3}>
          ...
          <div className="mb-6 text-[#525252]">
            <p className="mb-2">La responsable puede recopilar información personal para completar distintas transacciones, por ejemplo:</p>
            <ul className="ml-6 list-disc space-y-2">
              <li className="pl-2"><strong>Gestión de la cuenta del Cliente B2B:</strong> Creación de perfiles y verificación de usuarios para el acceso a la plataforma.</li>
              <li className="pl-2"><strong>Cumplimiento del Contrato:</strong> Realizar el cálculo, timbrado, dispersión y gestión de la nómina de los empleados de nuestros Clientes.</li>
              <li className="pl-2"><strong>Obligaciones Laborales y Fiscales:</strong> Cumplimiento de obligaciones patronales ante el SAT, IMSS e INFONAVIT.</li>
              <li className="pl-2"><strong>Gestión de Recursos Humanos:</strong> Administrar y automatizar incidencias de empleados.</li>
              <li className="pl-2"><strong>Procesamiento de Pagos:</strong> Procesar pagos bancarios y emitir CFDI correspondiente.</li>
              <li className="pl-2"><strong>Soporte Técnico:</strong> Atender solicitudes relacionadas con la operatividad de la plataforma.</li>
              <li className="pl-2"><strong>Seguridad:</strong> Monitorear la actividad para evitar fraudes y amenazas.</li>
              <li className="pl-2"><strong>Mejora de la Operatividad:</strong> Elaborar estudios y estadísticas internas.</li>
              <li className="pl-2"><strong>Transferencia Indispensable:</strong> Compartir información con terceros necesarios para el servicio.</li>
              <li className="pl-2"><strong>Aceptación Legal:</strong> Cumplimiento de obligaciones contractuales y legales.</li>
            </ul>
          </div>
          ...
          <p className="mb-4 text-[#525252]">Finalidades no necesarias, que permitirán brindar una mejor atención:</p>
          
          <ul className="mb-4 ml-6 list-disc text-[#525252] space-y-2">
            <li className="pl-2">Brindarle información actualizada sobre nuevas funcionalidades, módulos o servicios.</li>
            <li className="pl-2">Comunicación a través de boletines de noticias (newsletters) y correos electrónicos con contenido de valor.</li>
            <li className="pl-2">Comunicación sobre ofertas, promociones personalizadas y servicios complementarios.</li>
            <li className="pl-2">Seleccionar contenido y personalizar las interfaces de la aplicación.</li>
            <li className="pl-2">Permitir participación en encuestas de calidad, estudios de opinión o concursos.</li>
            <li className="pl-2">Investigaciones de mercado y prospección comercial.</li>
            <li className="pl-2">Elaborar campañas publicitarias y programas de mercadotecnia.</li>
            <li className="pl-2">Transferir datos de contacto a empresas filiales para fines de mercadotecnia.</li>
          </ul>
        ...
        {/* Datos Sensibles */}
        <Section id="datos" title="4. Datos Personales Sensibles Tratados" ref={sectionRefs} delay={0.4}>
          <p className="mb-6 text-[#525252]">
        ...
        {/* Transferencia */}
        <Section id="transferencia" title="5. Transferencia de Datos Personales" ref={sectionRefs} delay={0.5}>
          <HighlightBox>
            <p className="text-[#1a1a1a]">
          ...
          <div className="mt-6">
            <h3 className="font-['Crimson_Pro'] text-xl font-semibold text-[#1a1a1a] mb-4">
        ...
        {/* Derechos ARCO */}
        <Section id="arco" title="6. Ejercicio Derechos ARCO y Revocamiento" ref={sectionRefs} delay={0.6}>
          <p className="mb-4 text-[#525252]">
          ...
          <p className="mb-4 text-[#525252]">Para el ejercicio de sus derechos ARCO, deberá integrar su petición con los siguientes requisitos:</p>

          <ol className="mb-4 ml-6 list-decimal text-[#525252] space-y-2">
            <li className="pl-2">Petición firmada de su puño y letra, clara y concisa sobre los datos que desea modificar, ya sea en su versión impresa o digitalizada.</li>
            <li className="pl-2">Copia de una identificación oficial, en versión impresa o digitalizada.</li>
            <li className="pl-2">Para el caso de la solicitud a través de internet, llenar el formulario que le facilitamos para tal fin.</li>
          </ol>
        ...
        {/* Cookies */}
        <Section id="cookies" title="7. Recopilación de Información a través de Medios Automáticos" ref={sectionRefs} delay={0.7}>
          <p className="mb-4 text-[#525252]">
          ...
          <HighlightBox>
            ...
            <ul className="ml-6 list-disc text-[#1a1a1a] space-y-1">
        ...
        {/* Modificaciones */}
        <Section id="modificaciones" title="8. Modificaciones al Presente Aviso de Privacidad" ref={sectionRefs} delay={0.8}>
          <p className="mb-4 text-[#525252]">
        ...
        {/* Control y Seguridad */}
        <Section id="seguridad" title="9. Control y Seguridad" ref={sectionRefs} delay={0.9}>
          <p className="mb-4 text-[#525252]">
        ...
        {/* Aceptación */}
        <Section id="aceptacion" title="10. Aceptación e Información Adicional" ref={sectionRefs} delay={1.0}>
          <HighlightBox>
...
const CompanyInfo = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 my-6">
      {info.map((item, index) => (
        <div key={index} className="p-4 bg-[#fafaf8] rounded-lg border border-[#e5e5e5]">
          ...
          <div className="text-[#1a1a1a]">
            {item.link ? (
              <a
                ...
                className="text-emerald-600 hover:opacity-70 transition-opacity"
              >
                {item.value}
              </a>
            ) : (
...
const CookieResources = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h4 className="font-semibold text-[#1a1a1a] mb-3">Configuración de Cookies en Navegadores:</h4>
        <ul className="space-y-2">
          {browsers.map((browser, index) => (
            <li key={index} className="ml-6 list-disc text-[#525252]">
              <a href={browser.url} target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:opacity-70 transition-opacity">
                {browser.name}
              </a>
            </li>
          ))}
      ...
      <div>
        <h4 className="font-semibold text-[#1a1a1a] mb-3">Recursos Adicionales:</h4>
        <ul className="space-y-2">
          {resources.map((resource, index) => (
            <li key={index} className="ml-6 list-disc text-[#525252]">
              <a href={resource.url} target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:opacity-70 transition-opacity">
                {resource.name}
              </a>
            </li>
          ))}
