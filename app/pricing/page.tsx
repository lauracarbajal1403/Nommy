  ...
  const comparisonFeatures = [
    {
      ...
      features: [
        ...
        { name: "Cálculo de Finiquitos, liquidaciones, PTU, etc", basic: true, essential: true, enterprise: true },
        ...
        { name: "Exportación SUA TXT", basic: true, essential: true, enterprise: true },
        { name: "Cálculo de nómina", basic: false, essential: true, enterprise: true },
        { name: "Envío de recibos vía App", basic: false, essential: true, enterprise: true },
        { name: "Nóminas especiales", basic: true, essential: true, enterprise: true, highlighted: true },
        ...
        { name: "Dashboards interactivo de gastos de nómina, retención INFONAVIT e INFONACOT y gastos por departamento", basic: true, essential: true, enterprise: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Reacciones interactivo", basic: false, essential: true, enterprise: true },
      ]
    },
    {
      ...
      features: [
        ...
        { name: " Configuración de horarios", basic: true, essential: true, enterprise: true },
                    ...
                    {category.features.map((feature, featIndex) => (
                      <tr
                        ...
                        className={`hover:bg-gray-50 ${
                          feature.highlighted ? "bg-yellow-50" : ""
                        }`}
                      >
                        <td className="px-2 py-3 sticky left-0 bg-white z-10 break-words">
                          {feature.name}
                        </td>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation>
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold text-[#274263] mb-4">Preguntas Frecuentes</h2>
